%Group Members:	Archit Rathore 12152
%		Lucky Sahani	12383
%		Shubham Agrawal	12687
...
% Apply the binding of arguments of procedure
...
%Find if an element Y is present in Xs
fun {FindInList Xs Y}
   case Xs
   of nil then false
   [] H|T then
...
% Find the closure environment of procedure
...
%Create procedure environemnt E'
